...
const CardTotalPrice: React.FC<CardTotalPriceProps> = ({
  title,
  totalRevenue,
  totalProgress,
  children,
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white py-3 px-4 shadow-default dark:border-strokedark dark:bg-boxdark">
