...
const ChatBox: React.FC<ChatBoxProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed bottom-1 right-4 w-90 h-100 bg-primary text-white rounded-t-lg shadow-lg flex flex-col">
      <div className="flex items-center justify-between p-2 bg-secondaryGreen rounded-t-lg">
        ...
        <div className="mt-4">
          ...
          <div className="flex items-start mb-4 justify-end">
            <div className="bg-teal-700 p-2 rounded text-white">
              Tôi cần hỗ trợ về đơn hàng của mình.
            </div>
            <img
              src={customerInfo.avatar}
              alt="Avatar"
      ...
      <div className="p-2 bg-secondaryGreen rounded-b-lg flex items-center">
        ...
        />
        <button className="ml-2 p-2 bg-teal-700 text-white rounded">Gửi</button>
      </div>
    </div>
  );
};
