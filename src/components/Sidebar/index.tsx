            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-teal-300 dark:hover:bg-meta-4 ${
                    pathname.includes('profile') && 'bg-teal-300 dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/tables"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-teal-300 dark:hover:bg-meta-4 ${
                    pathname.includes('tables') && 'bg-teal-300 dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              {/* <!-- Menu Item QuoteDetail --> */}
              <li>
                <NavLink
                  to="/quotedetail"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-teal-300 dark:hover:bg-meta-4 ${
                    pathname.includes('quotedetail') &&
                    'bg-teal-300 dark:bg-meta-4'
                  }`}
                >
                  <svg
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/chart"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-teal-300 dark:hover:bg-meta-4 ${
                    pathname.includes('chart') && 'bg-teal-300 dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
