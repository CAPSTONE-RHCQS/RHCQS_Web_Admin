// src/pages/Manager/DesignPrice/component/Edit/EditDesignPrice.tsx
...
const EditDesignPrice: React.FC<EditModalProps> = ({
  isOpen,
  inputValue,
  onInputChange,
  onSave,
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-white p-6 rounded shadow-lg w-1/2 max-h-[80vh] overflow-y-auto no-scrollbar">
        <h2 className="text-lg font-bold mb-4">Chỉnh sửa giá thiết kế</h2>
        
        <strong className="font-bold">Diện tích từ (m2):</strong>
        <input
          type="number"
        ...
        <strong className="font-bold">Diện tích đến (m2):</strong>
        <input
          type="number"
...
export default EditDesignPrice;