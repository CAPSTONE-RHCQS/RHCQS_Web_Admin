    ...
    <table className="w-full table-auto">
      <thead>
        <tr className="bg-gray-2 text-left dark:bg-meta-4">
          ...
          <th className="py-4 px-4 font-medium text-black dark:text-white">Loại hợp đồng</th>
          <th className="py-4 px-4 font-medium text-black dark:text-white">Trạng thái</th>
          <th className="py-4 px-4 font-medium text-black dark:text-white">Nội dung</th>
      ...
      <tbody>
        {contractData.map((item, index) => (
          <tr key={index}>
            ...
            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">{item.Note ?? 'N/A'}</td>
